...
//    List<ImageDocument> documents = null;
    private OnPostExecuteListener mListener = null;
//    private ImageToPDF imageToPDF = null;
    private FilterActivityForTesting filteractivity =null;
...
//    public ImageToPDFAsync(filteractivity filteractivity) {
//
//    }

//    public ImageToPDFAsync(Filteractivity filteractivity, ArrayList<ImageDocument> documents, String fileName, Object onPostExecuteListener) {
//        mdocuments = documents;
//        this.mListener = (OnPostExecuteListener) onPostExecuteListener;
...
//    }
    ...
    public void ImageToPDFAsyncfilter(FilterActivityForTesting activity, List<ThumbnailItem> documents, String fileName, OnPostExecuteListener onPostExecuteListener) {
//        mdocuments = documents;
        this.mListener = onPostExecuteListener;
        this.filteractivity = activity;
        this.mFileName = fileName;
...
//        filteractivity.showBottomSheet(items.size());
    ...
    protected Boolean doInBackground(Void... voids) {
        File root = (File) filteractivity.getFilesDir();
...
//
//       File file2 = new File( Environment.getExternalStorageDirectory().getAbsolutePath() + "/Dir");
        if (file.exists())
            file.delete();
        try {
