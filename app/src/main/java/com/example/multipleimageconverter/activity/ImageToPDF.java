...
import com.example.multipleimageconverter.misc.ItemTouchHelperClass;
import com.example.multipleimageconverter.R;
import com.example.multipleimageconverter.modelClass.SpacingItemDecoration;
import com.example.multipleimageconverter.adapter.AdapterGridBasic;
...
import com.example.multipleimageconverter.recyclerview.RecyclerViewEmptySupport;
...
public class ImageToPDF extends AppCompatActivity {
    ...
    private FloatingActionButton savetogallery;
...
////                Toast.makeText(getApplicationContext(), "Pakistan Zindabad", Toast.LENGTH_SHORT).show();
//
...
//        mCollageIt = findViewById(R.id.converttopdf);
...
//            }
//        });
        // FIXME: 02/02/2022 Gallery intent
...
/*        mAdapter.setOnItemClickListener(new AdapterGridBasic.OnItemClickListener() {
         ...
         *//*       if (mAdapter.getSelectedItemCount() > 0) {
                    ...
                    // TODO : Crop image activity
                 *//**//*   CropImage
                            .activity(mAdapter.getItem(position)
                                    .getImageDocument())
                            .start(mainActivity);*//**//*
            ...
            if (result != null) {
                ...
                if (result.getClipData() != null) {
                   ...
                   /* Intent intent = new Intent(this, CroppedActivity.class);
                    ...
                    ImageDocument document = new ImageDocument(imageUri, this);
                    String singleList = String.valueOf(document);
                    intent.putExtra("mylistsingle", singleList);
                    this.startActivity(intent);
*/
                    Uri imageUri = result.getData();
                    uriList.add(imageUri);
...
//
//
//                Toast.makeText(this, "Pakistan zindabad  : " + cropped.getUri() , Toast.LENGTH_SHORT).show();
...
/*
                    intent.putExtra("cameraFirstValue", firstImage);
                    intent.putExtra("cameraSecongValue", secondImage);*/
                    startActivity(intent);
...
//        finish();
    ...
    public void showBottomSheet2(int size) {
        bottomSheetDialog.show();
        this.progressBar.setProgressMax(size);
        this.progressBar.setProgress(0);
    }
...
//        File directory = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/imageTOPdfJibran");
//
//        if (!directory.exists()){
//            directory.mkdirs();
//        }
...
//            Toast.makeText(this, "Image Saved : " + directory.toString(), Toast.LENGTH_SHORT).show();
//        } catch (Exception e) {
//            e.printStackTrace();
//        } finally {
//            try {
