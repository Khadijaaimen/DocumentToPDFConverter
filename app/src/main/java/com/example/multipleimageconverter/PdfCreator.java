...
public class PdfCreator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(PdfCreator.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            CheckStoragePermission();
        }
    ...
    private void InitializeComponent() {
        ...
        collage_unfocus.setBackgroundTintList(PdfCreator.this.getResources().getColorStateList(R.color.purple_700));
    ...
    private void setFocus(LinearLayout collage_unfocus, LinearLayout collage_focus) {
        if (collage_unfocus != collage_focus) {
            collage_focus.setBackgroundTintList(PdfCreator.this.getResources().getColorStateList(R.color.collage_state));
            collage_unfocus.setBackgroundTintList(PdfCreator.this.getResources().getColorStateList(R.color.collage_unfocus));
