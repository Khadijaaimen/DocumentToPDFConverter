...
import com.example.multipleimageconverter.recyclerview.MainViewHolder;
...
//    List<File> items = new ArrayList<>();
    ...
    //    public MainAdapter(Context context, List<File> pdfFile , OnItemClickListener onItemClickListener) {
...
//       return filteredUserDataList.get(getItemCount()) == null ? VIEW_TYPE_LOADING : VIEW_TYPE_ITEM;
//    }
...
//        Glide.with(context)
//                .load(items.get(position)).load(items)
//                .into(holder.pdf_imageView);
