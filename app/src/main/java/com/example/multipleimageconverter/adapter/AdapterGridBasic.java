package com.example.multipleimageconverter.adapter;
...
//                        Intent intent = new Intent(ctx, CroppedActivity.class);
////                    ctx.startActivity(view1, items.get(position), holder.getAdapterPosition());
////                    Intent intent=new Intent(ctx,CroppedActivity.class);
////                    intent.putExtra(String.valueOf(items),items);
...
//
            ...
            // TODO :Yahan py intent lagain to agli activity py jata hy
//            view.bt_crop.setOnClickListener(view1 -> {
//                if (mOnItemClickListener != null) {
